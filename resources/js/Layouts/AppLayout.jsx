                        ...
                        <div className="ml-3 relative">
                            <Dropdown>
                                <Dropdown.Trigger>
                                    <span className="inline-flex rounded-md">
                                        <button type="button"
                                            ...
                                            {auth?.user?.name ?? "Authentification"}
                                ...
                                <Dropdown.Content>
                                    ...
                                    <Dropdown.Link href={route('shorts.show')}>My shorts</Dropdown.Link>
                ...
                <div className="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                    <div className="space-y-1">
                        ...
                        <div className="mt-3 space-y-1">
                            ...
                            <ResponsiveNavLink href={route('shorts.show')} active={route().current('shorts.show')}>
                                My shorts
                            </ResponsiveNavLink>
                        </div>
                        ) : (
